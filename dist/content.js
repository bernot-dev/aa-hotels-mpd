...
const createMilesPerDollarElement = (mpd) => {
...
const createMaxMilesPerDollarElement = (mpd) => {
...
const getNights = () => {
    const checkInDate = document.getElementById('check-in-date')?.value ?? 1;
...
const showMilesPerDollar = (resultsListContainer) => {
...
const waitForElem = (elementSelector) => {
