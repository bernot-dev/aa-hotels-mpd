...
|---------|------|---------|--------|
| 1.5.0 | 2026-09-19 | Resilient SPA route monitoring, idempotent badge injection, bonus miles support, bounded room expansion, and DOM snapshot fixture export tool. | Draft |
